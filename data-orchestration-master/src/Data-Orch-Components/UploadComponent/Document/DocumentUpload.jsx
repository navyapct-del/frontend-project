    ...
    for (let i = 0; i < inputFields.length; i++) {
      if (images[i] === e[0].name) {
        ...
        if (props.type == "document") {
          // console.log("line 173", e[0].name.split(".")[1]);
          if (
            documentextention.find((st) => st === e[i].name.split(".")[1]) !=
            null
          ) {
            setAddBtnException(true);
      ...
      for (let i = 0; i < e.length; i++) {
        if (props.type == "document") {
          if (
            ...
            setFormatNotSupportedDisable(true);
            setAddBtnException(true);
            // console.log("line 226 disable", formatnotsupporteddisable);
            file = [e[i]];
            inputFields.push({
              description: "",
              tags: [],
