...
function Main() {
  ...
  const validatePassword = (newPassword) => {
    ...
    const valid =
      ...
      newValidations.hasSpecialChar &&
      newValidations.isMinLength;
    ...
    UserPool.signUp(email, password, attributeList, null, (err, data) => {
      if (err) {
        if (err.code === "UsernameExistsException") {
          ...
          setErrorMessage("try with different username");
        } else {
        ...
        <div className="container sm:px-10">
          <div className="block xl:grid grid-cols-2 gap-4">
            ...
            <div className="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
              <div className="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-3/4 lg:w-2/4 xl:w-3/5">
                ...
                {!otpSent ? (
                  ...
                  >
                    <div className="intro-x mt-8">
                      ...
                      <input
                        ...
                        onBlur={() => password === "" && setInputActive(false)}
                  ...
                  <>
                    <form className="space-y-6" onSubmit={onVerify}>
                      <div className="mt-4">
                        <p className="mt-4 text-gray-400 welcome_p">
                      ...
                      <div className="m-5 py-1 flex justify-center">
                        <button
                          type="submit"
                          className="btn btn-primary py-3 px-4 w-full xl:w-32 align-top text-center "
                        >
                          Verify OTP
                        </button>
                      </div>
